...
const TeacherRegistrationScreen = ({ navigation }) => {
  ...
  const subjects = ['Mathematics', 'English', 'Science', 'History', 'Physical Education', 'Computer Science'];
  const departments = ['Science & Math', 'Languages', 'Social Studies', 'Sports', 'Technology'];
  ...
  const handleRegister = () => {
    ...
    setTimeout(() => {
      Alert.alert(
        'Success',
        `Teacher ${formData.name} registered successfully!`,
        [
          {
            text: 'OK',
            onPress: () => {
    ...
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      <View style={styles.headerContainer}>
        <MaterialCommunityIcons
          ...
          color="#4CAF50"
        />
        <Text style={styles.headerTitle}>Register New Teacher</Text>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.photoSection}>
          <Text style={styles.sectionTitle}>Teacher Photo (Optional)</Text>
          <TouchableOpacity
        ...
        <View style={styles.formSection}>
          ...
          <TextInput
            ...
            outlineColor={errors.name ? '#d32f2f' : '#4CAF50'}
            disabled={isLoading}
          ...
          <TextInput
            ...
            outlineColor={errors.email ? '#d32f2f' : '#4CAF50'}
            disabled={isLoading}
          ...
          <Menu
            ...
            onDismiss={() => setSubjectDropdownVisible(false)}
            anchor={
              <Button
                ...
                style={[styles.dropdown, errors.subject && styles.inputError]}
                disabled={isLoading}
                icon="chevron-down"
              >
          ...
          <TextInput
            ...
            outlineColor={errors.phone ? '#d32f2f' : '#4CAF50'}
            disabled={isLoading}
            placeholder="555-1001 or 5551001"
          ...
          <TextInput
            ...
            outlineColor={errors.qualification ? '#d32f2f' : '#4CAF50'}
            disabled={isLoading}
          ...
          <TextInput
            ...
            outlineColor={errors.experience ? '#d32f2f' : '#4CAF50'}
            disabled={isLoading}
          ...
          <TextInput
            ...
            outlineColor={errors.office ? '#d32f2f' : '#4CAF50'}
            disabled={isLoading}
